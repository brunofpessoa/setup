...
brew install curl jq zsh zsh-autosuggestions zsh-syntax-highlighting eza bat thefuck zoxide git go luarocks lazygit node neovim ripgrep xclip syncthing fzf powerlevel10k yazi nvm &&
